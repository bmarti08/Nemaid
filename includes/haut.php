...
<SCRIPT language="javascript">
    function popUp(page) {
      window.open(page);
							...
							Designed by Renaud Fortuner (fortuner@wanadoo.fr) - Developped by students from the University of Poitiers, France							
						</center>
			<?php
							...
							<table class="menu">
								<tr>	
									...
									if (curPageName()=='new_sample.php') {
										...
										echo'<td class="menu"><a href="new_sample.php">Sample data entry</a></td>';
										...
										if(isset($_SESSION['admin'])){
											...
											echo'<td class="menu"><a href="administrationbis.php">Database management</a></td>';
											}
										else
											echo '<td class="menu"><a href="visuBDD.php">Databases</a></td>';
