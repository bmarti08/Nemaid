...
<input type="button" name="Return" value="Return" onClick="document.location='visuBDDBySpeciesData.php'" /><br />
<?php
...
while ($rowChar = mysqli_fetch_array($character)){
	...
	$val = mysqli_query($con,'SELECT value_character from POPULATION natural join ANALYSIS natural join IS_COMPOUND_BY where id_character ="'.$idCharacter.'"');
